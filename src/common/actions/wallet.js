...
export async function updateBalance() {
    const balance = await WalletStore.wallet.getBalance();
    WalletStore.setBalance(balance);
}

export async function updateContractBalance() {
    const balance = await WalletService.updateContractBalance(WalletStore.contract, WalletStore.wallet);
    WalletStore.setContractBalance(balance);
}
